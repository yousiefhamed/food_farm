  ...
  return (
    <main className="w-full">
      <section
        ...
        className="w-full min-h-[500px] flex flex-col justify-start items-center overflow-hidden rounded-bl-[50px] py-24 px-5 text-center"
      >
        <h1
        ...
        <p className="text-gray-500 text-base font-medium max-w-[500px] pt-2 pb-5">
          ...
          vero iste aliquid, reprehenderit distinctio laudantium magni excepturi
        </p>
